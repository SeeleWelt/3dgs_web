  ...
  <div class="empty-state">
    ...
    <template v-else-if="error === 'network'">
      <div class="error-state-wrapper">
        ...
        <div class="error-content">
          <p class="error-title">{{ t('emptyStateErrors.network.title') }}</p>
          <p class="error-desc">{{ t('emptyStateErrors.network.description') }}</p>
          <button class="retry-btn" @click="$emit('retry')">
            <ReloadOutlined />
            {{ t('emptyStateErrors.retry') }}
          </button>
        </div>
      </div>
    </template>
    ...
    <template v-else-if="error === 'server'">
      <div class="error-state-wrapper">
        ...
        <div class="error-content">
          <p class="error-title">{{ t('emptyStateErrors.server.title') }}</p>
          <p class="error-desc">{{ t('emptyStateErrors.server.description') }}</p>
          <button class="retry-btn" @click="$emit('retry')">
            <ReloadOutlined />
            {{ t('emptyStateErrors.retry') }}
          </button>
    ...
    <template v-else>
      <div class="error-state-wrapper">
        ...
        <div class="error-content">
          <p class="error-title">{{ t('emptyStateErrors.unknown.title') }}</p>
          <p class="error-desc">{{ t('emptyStateErrors.unknown.description') }}</p>
          <button class="retry-btn" @click="$emit('retry')">
            <ReloadOutlined />
            {{ t('emptyStateErrors.retry') }}
          </button>
