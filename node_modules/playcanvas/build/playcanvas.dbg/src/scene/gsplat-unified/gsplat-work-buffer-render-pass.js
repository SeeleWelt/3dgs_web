 ...
 */ class GSplatWorkBufferRenderPass extends RenderPass {
     ...
     *
     * @type {GSplatInfo[]}
     */ this.splats = [], /** @type {number[][]|undefined} */ this.colorsByLod = undefined, /**
     * The camera node used for rendering.
     *
     * @type {GraphNode}
     */ this.cameraNode = /** @type {any} */ null, /** @type {Float32Array} */ this._modelScaleData = new Float32Array(3), /** @type {Float32Array} */ this._modelRotationData = new Float32Array(4);
