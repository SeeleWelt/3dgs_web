 ...
 */ class GSplatManager {
     ...
     */ constructor(device, director, layer, cameraNode){
        /** @type {GraphNode} */ this.node = new GraphNode('GSplatManager');
        /**
     ...
     */ this.gpuSorter = null;
        /** @type {number} */ this.sortedVersion = 0;
        /**
     ...
     */ this._centersVersions = new Map();
        /** @type {number} */ this.framesTillFullUpdate = 0;
        /** @type {Vec3} */ this.lastLodCameraPos = new Vec3(Infinity, Infinity, Infinity);
        /** @type {Vec3} */ this.lastLodCameraFwd = new Vec3(Infinity, Infinity, Infinity);
        /** @type {Vec3} */ this.lastSortCameraPos = new Vec3(Infinity, Infinity, Infinity);
        /** @type {Vec3} */ this.lastSortCameraFwd = new Vec3(Infinity, Infinity, Infinity);
        /** @type {boolean} */ this.sortNeeded = true;
        /** @type {Vec3} */ this.lastColorUpdateCameraPos = new Vec3(Infinity, Infinity, Infinity);
        /** @type {Vec3} */ this.lastColorUpdateCameraFwd = new Vec3(Infinity, Infinity, Infinity);
        /**
     * Layer placements, only non-octree placements are included.
     *
     * @type {GSplatPlacement[]}
     */ this.layerPlacements = [];
        /** @type {boolean} */ this.layerPlacementsDirty = false;
        /** @type {Map<GSplatPlacement, GSplatOctreeInstance>} */ this.octreeInstances = new Map();
        /**
